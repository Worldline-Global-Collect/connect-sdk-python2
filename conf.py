...
author = u'Worldline Global Collect'
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'modules.rst', 'modules_api_versions.rst', 'modules_webhooks.rst']
...
#
# html_title = u'Python SDK v5.7.0'
