...
class CommunicatorTest(unittest.TestCase):
    ...
    def test_to_uri_without_request_parameters(self):
        ...
        self.assertEquals("https://api.preprod.connect.worldline-solutions.com/v1/merchant/20000/convertamount", uri1.geturl())
        self.assertEquals("https://api.preprod.connect.worldline-solutions.com/v1/merchant/20000/convertamount", uri2.geturl())
    ...
    def test_to_uri_with_request_parameters(self):
        ...
        self.assertEquals("https://api.preprod.connect.worldline-solutions.com/v1/merchant/20000/convertamount"
